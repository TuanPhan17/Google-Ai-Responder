...
import { unapproveReview } from "@/reviews/approval.service";
...
export async function POST(request: NextRequest, context: { params: Promise<{ id: string }> }) {
  return withAdmin("reviews.unapprove", async () => {
    ...
    return unapproveReview(parsedId.data, { actor: parsedBody.data.actor });
  });
}

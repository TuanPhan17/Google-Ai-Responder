...
import { regenerateReviewResponse } from "@/reviews/approval.service";
...
export async function POST(request: NextRequest, context: { params: Promise<{ id: string }> }) {
  return withAdmin("reviews.regenerate", async () => {
    ...
    return regenerateReviewResponse(parsedId.data, { actor: parsedBody.data.actor });
  });
}
